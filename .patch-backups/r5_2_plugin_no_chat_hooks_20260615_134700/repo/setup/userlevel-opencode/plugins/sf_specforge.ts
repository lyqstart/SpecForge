/* R5.1_PLUGIN_PASSTHROUGH_HOTFIX */
/**
...
async function postEvent(type: string, data: unknown): Promise<void> {
  try {
    // R5.1：telemetry 只能旁路执行，不能阻塞 chat transform / event hook。
    void daemonClient.postEvent(currentSessionId, type, data).catch(() => {});
  } catch {
  ...
  return {
    ...
    event: async (i: any) => {
      ...
      if (evt && typeof evt === "object") {
        ...
        void postEvent(`opencode.${eventType}`, {
          id: evt.id,
          type: eventType,
        ...
        void postEvent("opencode.event", { raw: typeof evt, trace_id });
      }
    },
    ...
    "experimental.session.compacting": async (i: any) => {
      ...
      void postEvent("session.compacting", { sessionID: i.sessionID, trace_id });
    },
    ...
    "experimental.chat.system.transform": async (i: any, o: any) => {
      ...
      if (!shouldIgnoreSfObservationEvent(projectDir, "experimental.chat.system.transform")) void postEvent("llm.context.prepared", summarizeOpenCodeEventForDaemon("experimental.chat.system.transform", { system: o.system, sessionID: i.sessionID, trace_id })); return o;
    },
    ...
    "experimental.chat.messages.transform": async (i: any, o: any) => {
      ...
      if (!shouldIgnoreSfObservationEvent(projectDir, "experimental.chat.messages.transform")) void postEvent("llm.messages", summarizeOpenCodeEventForDaemon("experimental.chat.messages.transform", { messages: o.messages, sessionID: i?.sessionID, trace_id })); return o;
    },
    ...
    "chat.params": async (i: any, o: any) => {
      ...
      void postEvent("chat.params", { params: o, sessionID: i.sessionID, trace_id }); return o;
    },
    ...
    "chat.headers": async (i: any, o: any) => {
      ...
      void postEvent("chat.headers", { headers: safe, sessionID: i.sessionID, trace_id }); return o;
    },
  };
}
