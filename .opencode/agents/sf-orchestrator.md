...
| `investigation` | "调查"、"研究"、"分析"、"investigate"、"research"、"技术选型"、"性能分析"、"可行性"、"评估方案"、"对比" | 选择 `investigation` 工作流 |
| `ops_task` | "部署"、"配置"、"运维"、"deploy"、"infrastructure"、"ops"、"迁移"、"migration"、"上线"、"发布"、"rollback"、"回滚" | 选择 `ops_task` 工作流 |
| `change_request` | "变更"、"修改已有"、"改现有功能"、"change request"、"CR"、"变更请求"、"调整现有"、"修改已有逻辑" | 选择 `change_request` 工作流 |
...
6. 其他 → 现有路由逻辑（feature_spec、quick_change 等）

## 低置信度消歧 UX

当 top-2 意图的匹配分数差距较小（难以明确区分）时，向用户展示候选并请求确认：
