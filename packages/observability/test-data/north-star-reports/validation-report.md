...
**Generated:** 2026-05-29T00:36:59.772Z
**Schema Version:** 1.0
...
|----------|--------|-----------|------------|------------|----------|
| gate-repeated-failure | ✅ PASS | 7 | Gate "RequirementsGate" failed 5 times | 100.0% | 5 |
| agent-deviation | ✅ PASS | 3 | Most frequent action: session.started (1 occurrences) | 50.0% | 3 |
| tool-invocation-error | ✅ PASS | 3 | Most frequent action: tool.invoke (1 occurrences) | 50.0% | 2 |
| permission-denial | ✅ PASS | 2 | Permission denied by rule "deny-protected-files" (3 times) | 100.0% | 3 |
| upgrade-installation-failure | ✅ PASS | 5 | Most frequent action: system.upgrade (1 occurrences) | 50.0% | 1 |
| state-machine-stuck | ✅ PASS | 3 | Workflow stuck at: running | 80.0% | 1 |
| concurrency-deadlock | ✅ PASS | 2 | Most frequent action: workflow.transition (2 occurrences) | 50.0% | 2 |
| skill-invocation-check | ✅ PASS | 3 | Most frequent action: skill.invoked (1 occurrences) | 50.0% | 2 |
| workflow-execution-check | ✅ PASS | 4 | Most frequent action: workflow.executing (2 occurrences) | 50.0% | 3 |
| workflow-result-deviation | ✅ PASS | 3 | 1 workflow results deviated from expected | 90.0% | 1 |
