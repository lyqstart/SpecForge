...
describe('SpecForge development experience pre-read gate', () => {
  ...
  it('records every new error with a class-level prevention rule', () => {
    ...
    expect(document).toContain('ERR-078=FIXED_V42_COMMITTED_PUSHED_PENDING_USERLEVEL_INSTALL_WORKDESK_RETEST');
    ...
    expect(document).toContain('ERR-075=FIXED_V42_COMMITTED_PUSHED_PENDING_USERLEVEL_INSTALL_WORKDESK_RETEST');
