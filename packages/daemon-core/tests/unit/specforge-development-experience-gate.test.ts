...
describe('SpecForge development experience pre-read gate', () => {
  ...
  it('records every new error with a class-level prevention rule', () => {
    ...
    expect(document).toContain('ERR-088=FIXED_V50_COMMITTED_PUSHED_PENDING_USERLEVEL_UPGRADE_WORKDESK_RETEST');
    ...
    expect(document).toContain('ERR-075=FIXED_V50_COMMITTED_PUSHED_PENDING_USERLEVEL_UPGRADE_WORKDESK_RETEST');
