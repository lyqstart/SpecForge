...
## CURRENT EXECUTION STATE — 2026-08-10

```text
GLOBAL_GOAL=用真实独立项目完整跑通 SpecForge E2E，并修复全部阻断当前主线的 SpecForge 产品治理缺陷
CURRENT_STAGE=WI0004_V217_RECOVERY_COMPLETE_ERR414_ERR416_CLOSED_V220_WAIT_DAEMON_RESTART
CURRENT_STAGE_STATUS=RECOVERY_EVIDENCE_VALIDATED_PRODUCT_FIX_INSTALLED_STATE_PROJECTION_COMPENSATED
LAST_COMPLETED_STAGE=WI0004_FORMAL_CLOSED_SPEC_MIGRATION_RECOVERY_AND_STATE_PROJECTION_COMPENSATION_COMPLETE
CURRENT_BLOCKER=DAEMON_MUST_BE_MANUALLY_RESTARTED_WITH_V220_BEFORE_CHECKPOINT_PRECONDITION_RECONCILIATION
REMOTE_HEAD_BASELINE=LIVE_GIT_REF_REQUIRED_NOT_STORED_AS_SELF_REFERENTIAL_HANDOFF_FACT
AUTHORITY_BASELINE_COMMIT=91b63289a0c4b148c5d5a7d045787985cb024bd4
VALIDATION_PROJECT=D:\code\temp\SpecForge-P0-Validation
CURRENT_WI=WI-0004
AUTHORITATIVE_WI_STATE=closed
LATEST_IMMUTABLE_EVIDENCE=attempt-0006:source=gate_run:summary_status=passed:verification_gate=passed:formal_version_gate=passed
LATEST_USER_DECISION_ID=UD-WI-0004-1786250536633
LATEST_USER_DECISION_STATUS=approved
LATEST_USER_DECISION_TYPE=user_approved
LATEST_USER_DECISION_FILE_SHA256=68496A47D510DC964D0F3A0C81171ABEC38FEEE6C9DCD9062C3361C8BC795109
LATEST_USER_DECISION_MANIFEST_HASH=sha256:e4f716bcb03ad370754d8cf299d115fd1fce5d69c363faaec0b7dba1c036c125
LATEST_USER_DECISION_GATE_SUMMARY_HASH=sha256:efc0fcd720a87451dea0555e260296b22970f093b7c64b99c49c07e943053191
LATEST_STATE_TRANSITION_EVENT_ID=019fe5dd-f4ae-72ff-842c-5ebccc4bcdbb
LATEST_ATOMIC_SPEC_MERGE_RECEIPT=V166:TOOL_INVOCATION_COUNT=1:REQUEST_STARTED=YES:RESPONSE_RECEIVED=YES:STATE_BEFORE=approved:STATE_AFTER=merged
ATOMIC_SPEC_MERGE_ACTION_STATUS=PERFORMED_ONCE
ATOMIC_SPEC_MERGE_RERUN_ALLOWED=NO
V166_POST_ACTION_AUDIT_RESULT=FAILED_FALSE_POSITIVE_EXPECTED_OBSERVABILITY_SIDE_EFFECTS_OMITTED
V166_FORBIDDEN_SIDE_EFFECTS_AUDIT=PASS_NO_CANDIDATE_GATE_USER_DECISION_MUTATION
POST_MERGE_PROJECT_SPEC_VERSION=PSV-0004
POST_MERGE_MERGE_REPORT=PASS_SUCCESS_FAILED_ZERO_PSV0004
POST_MERGE_TRANSITION_SEQUENCE=PASS_APPROVED_MERGE_READY_MERGING_MERGED
LATEST_PRODUCT_FIX=SF_GIT_BRANCH_CREATE_NONPERSISTING_AUTHORITATIVE_STATE_READ_V220
LATEST_FORMAL_RECOVERY=V217:sf_git_branch_create:closed_spec_migration:attempt-0006:success
LATEST_RECOVERY_EVIDENCE_SHA256=3B0B6D545C11F337C4586A97551633EA06026F7D69CE5D30372574CD83A92474
LATEST_RECOVERY_POST_AUDIT=V217_FAIL_CLOSED_ERR414_EXTRA_STATE_PROJECTION_WRITE_COMPENSATED_V220
LATEST_VALIDATION_STATE_PROJECTION_SHA256=964F6DA998243281217C32DFF3CDB5F094804A37C4E67135D3AF318DBC96DD89
LATEST_VALIDATION_STATE_VERSION=568
AUTHORITY_BRANCH=main
WORK_BRANCH=main
DELIVERY_FORMAT=ONE_COMPLETE_ZIP_PLUS_ONE_COPY_PASTE_CMD
POWERSHELL_ALLOWED=NO
FEEDBACK_CONTRACT=GOV-STAGE-RECEIPT-001
ARTIFACT_ACCEPTANCE_CONTRACT=GOV-STAGE-ARTIFACT-VERIFY-001
VALIDATOR_CONTRACT=GOV-STAGE-VALIDATOR-001
DELIVERY_IDENTITY_CONTRACT=GOV-STAGE-DELIVERY-IDENTITY-001
DELIVERY_INTERNAL_REFERENCE_CONTRACT=GOV-STAGE-DELIVERY-IDENTITY-001#INTERNAL_REFERENCE
LATEST_AUTHORITY_QUALITY_DEFECT=ERR-401_ERR411_CLOSED_BY_V210_BOOTSTRAP_DELIVERY_HARDENING
AUTHORITY_DATA_MODEL_APPLICABILITY=FILE_ALWAYS_PRESENT_ACTIVE_OR_NOT_APPLICABLE
AUTHORITY_ACCEPTANCE_MODEL=MATRIX_RULE_EVIDENCE_GATE_STATE
AUTHORITY_PHASE_MODEL=REFERENCE_ONLY_NO_RULE_REDEFINITION
AUTHORITY_DYNAMIC_FACT_POLICY=HANDOFF_RECEIPT_GIT_IMMUTABLE_EVIDENCE
AUTHORITY_PRODUCT_LIFECYCLE_SOURCE=3.1_CANONICAL_PRODUCT_LIFECYCLE
AUTHORITY_APPROVED_DEDUP_SCOPE=D1_D19
READ_ONLY_RECONCILIATION_RESULT=PASS_ATOMIC_SPEC_MERGE_PERSISTED_CORRECTLY
RECONCILED_PRIOR_DELIVERY_RECEIPT=INVALID_AUTHORITY_HEAD_USED_AUTHORITY_FILE_COMMIT
RECONCILED_PRIOR_DELIVERY_RESULT=PASS_REPOSITORY_CHANGE_VALID_RECEIPT_AUTHORITY_HEAD_INVALID
RECONCILED_PRIOR_DELIVERY_COMMIT=f1de17be55cc96358df9f9ac8c193bb657ba16dc
LATEST_REPOSITORY_COMMIT=LIVE_GIT_REF_REQUIRED_NOT_STORED_AS_SELF_REFERENTIAL_HANDOFF_FACT
LATEST_DELIVERY_DEFECT=ERR-416_V219_HARDCODED_RUNTIME_STATE_VERSION_ASSUMPTION_CLOSED_BY_V220
V127_RECEIPT_ACCEPTANCE=INVALID_DELIVERY_INTERNAL_REFERENCE_NEXT_STAGE_V124
V127_AUTHORITY_STRUCTURE_RESULT=PASS_12_NUMBERED_CHAPTERS_PLUS_APPENDIX_A_B_D1_D8
LATEST_AUTHORITY_STRUCTURE_COMMIT=2b82912925c62049ed8f968946fc284b94adfcd4
AUTHORITY_DOCUMENT_STRUCTURE=12_NUMBERED_CHAPTERS_PLUS_APPENDIX_A_B_DOMAIN_CANONICALIZED
BOOTSTRAP_ENVELOPE_CONTRACT=GOV-STAGE-BOOTSTRAP-ENVELOPE-001
BOOTSTRAP_EXECUTION_ORDER_CONTRACT=GOV-STAGE-BOOTSTRAP-ENVELOPE-001#G
LIVE_REF_RESOLUTION_CONTRACT=GOV-STAGE-AUTHORITY-BOOTSTRAP-001
OUTER_CMD_DELIVERY_CONTRACT=GOV-STAGE-DELIVERY-001
...
RECOVERY_ACCEPTANCE_CONTRACT=GOV-STAGE-RECOVERY-ACCEPT-001
AUTHORITY_BOOTSTRAP_CONTRACT=GOV-STAGE-AUTHORITY-BOOTSTRAP-001
PRIOR_FAILURE_RECONCILIATION=PASS_ERR401_ERR416_BACKFILLED
UNRECORDED_FAILURES=0
EXPERIENCE_FILE_READ=YES_LATEST_WITH_ERR416
EXPERIENCE_RE_READ_REQUIRED=NO_AFTER_ERR384_ERR389_BACKFILL
```
- V166 已对 `D:\code\temp\SpecForge-P0-Validation` 调用且只调用一次正式 `sf_v11_merge`；回执证明请求已发出、响应已收到、`STATE_BEFORE=approved`、`STATE_AFTER=merged`。
- V166 post-action audit 的唯一阻断是 5 个 `.specforge/logs/observability/**` 文件未列入 runner 的允许副作用模型。当前 daemon 源码证明这些路径是启用 observability 时的正常 dispatcher/index/payload CAS 输出，因此该失败属于外围 validator Expected Side Effects 模型缺口，不代表 Merge 未执行。
- `ATOMIC_SPEC_MERGE_ACTION_STATUS=PERFORMED_ONCE` 为不可回写事实；禁止重新调用 `sf_v11_merge`。
- Candidate、Gate、User Decision 保护内容在 V166 后保持不变；V166 没有执行 Code Permission、Implementation、Verification 或 Close。
- V166 因假失败提前停止，尚缺 PSV-0004、merge_report、exact merge transition sequence、正式 Spec 语义和 observability 记录的完整只读验收；下一阶段只允许只读 reconciliation。
- V168 第一次只读 reconciliation 包在交付前因 validator 把历史事件源字符串 `sf_v11_merge` 误判为 Tool 调用而失败；包未交付、未访问 Validation、未执行生命周期动作。ERR-320 已归入 EXP-244；同轮 artifact spreadsheet warmup timeout 复发按 ERR-321/EXP-072 单独记账。
- V170 第一次只读 reconciliation 包在交付前因 validator 把 `Path.open("rb")` 的 SHA256 读取误判为写能力而失败；包未交付、未访问 Validation、未执行生命周期动作。ERR-325 已归入 EXP-244，下一版必须使用 read/write mode-aware AST 能力审计。
- V171 第一次只读 reconciliation 包在交付前因 validator 把通用 Git helper 定义内部的 `*args` 转发误判为动态 Git 写入而失败；包未交付、未访问 Validation、未执行生命周期动作。ERR-326 已归入 EXP-244；同轮 artifact spreadsheet warmup timeout 复发按 ERR-327/EXP-072 单独记账。
- V172 第一次只读 reconciliation 包在交付前因 validator 把字符串 `replace()` 误判为文件替换写操作而失败；包未交付、未访问 Validation、未执行生命周期动作。ERR-328 已归入 EXP-244；同轮 spreadsheet warmup timeout 复发按 ERR-329/EXP-072 记账，并将后续非 spreadsheet ZIP 构建切换到普通 container/file 通道。
- V173 第一次只读 reconciliation 包使用普通 container/file 通道生成 ZIP 后，最终 Artifact Acceptance harness 因调用 `sys.executable` 但漏导入 `sys` 而失败；失败版未交付、未访问 Validation、未执行生命周期动作。ERR-330 复用历史 ERR-293/EXP-078，下一版必须实际执行最终 ZIP 内 validator 后才允许发布。
- V169 调查阶段新增 3 个助手侧取证失败：猜测源码路径 404（ERR-322）、跨页面猜 GitHub link id 导航到目录（ERR-323）、第一次 container.download 未先显式打开最终 raw URL（ERR-324）。三者均无用户仓库副作用，均已按 EXP-007/EXP-046/EXP-072 收口；下一阶段仍只允许 post-merge read-only reconciliation。
- read-only reconciliation 完成并 PASS 前，禁止 Post-Spec-Merge Gate 及其后所有生命周期动作。
- daemon / OpenCode 生命周期仍由用户手工控制；自动包不得启动、停止或重启。
