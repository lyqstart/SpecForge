...
CURRENT_STAGE=PHASE11_FRESH_PROJECT_PREPARATION
CURRENT_STAGE_STATUS=IDENTIFIED
LAST_COMPLETED_STAGE=POST_REINSTALL_DAEMON_HEALTH_ACCEPTED
LAST_COMPLETED_STAGE_STATUS=REAL_APPLIED
CURRENT_BLOCKER=FRESH_PHASE11_VALIDATION_PROJECT_NOT_YET_CREATED
REMOTE_HEAD_BASELINE=b3ec139ba68522ff98145f8567ff74bb362b1007
AUTHORITY_BASELINE_COMMIT=abec970dc6c95dc65d22a38ca57d059ee8f5c60c
VALIDATION_PROJECT=NOT_YET_CREATED_AFTER_OS_REINSTALL
HISTORICAL_VALIDATION_PROJECT=D:\code\temp\SpecForge-P0-Validation
CURRENT_WI=NONE
AUTHORITATIVE_WI_STATE=NOT_APPLICABLE_NO_CURRENT_VALIDATION_PROJECT
LATEST_IMMUTABLE_EVIDENCE=NONE_LOCALLY_AFTER_OS_REINSTALL
...
LATEST_DEVELOPMENT_FAILURE=ERR-492
HISTORICAL_PENDING_HARNESS_ERROR=ERR-480:FIX_IMPLEMENTED_PENDING_LIVE_RUNTIME_ACCEPTANCE
FAILURE_LEDGER_BACKFILL=ERR-481,ERR-482,ERR-483,ERR-484,ERR-485,ERR-486,ERR-487,ERR-488,ERR-489,ERR-490,ERR-491,ERR-492
PRIOR_FAILURE_RECONCILIATION=PASS
UNRECORDED_FAILURES=0
EXPERIENCE_FILE_READ=YES_LATEST_WITH_ERR492
APPLICABLE_EXPERIENCE_RULES=EXP-001,EXP-002,EXP-003,EXP-006,EXP-007,EXP-013,EXP-018,EXP-020,EXP-033,EXP-035,EXP-038,EXP-045,EXP-058,EXP-060,EXP-085,EXP-086,EXP-094
REPEATED_ERROR_CHECK=PASS
PRODUCT_COMPLETION_STATUS=NOT_COMPLETE
REMAINING_PRODUCT_MILESTONES=PHASE11_FRESH_PROJECT_E2E;PHASE12_HARD_ENFORCEMENT_RELEASE_BOUNDARY
...
DAEMON_LOCK_PID_MATCH=YES
DAEMON_HEALTH_HTTP_STATUS=200
DAEMON_HEALTH_STATUS=ok
DAEMON_HEALTH_PID_MATCH=YES
OPENCODE_STATUS=UNKNOWN
OPENCODE_RECOVERY_SESSION_ACTION=NOT_STARTED_BY_RECOVERY_SESSION
OPENCODE_ACTION_REQUIRED=USER_MANUAL_START_AFTER_FRESH_PHASE11_PROJECT_CREATED
OPENCODE_SESSION_MODE=START_NEW_SESSION_FOR_FRESH_PHASE11_PROJECT
OPERATION_BOUNDARY=PREPARE_FRESH_INDEPENDENT_PHASE11_PROJECT;KEEP_DAEMON_RUNNING;NO_OLD_WI0004_CONTINUATION;OPENCODE_LIFECYCLE_MANUAL_ONLY;NO_PHASE11_WI_LIFECYCLE_BEFORE_PROJECT_AND_SESSION_READY
FORBIDDEN_ACTIONS=SPECFORGE_SELF_DEVELOPMENT_WORK_ITEM,WORKFLOW,CANDIDATE,GATE,USER_DECISION,MERGE_RUNNER,CODE_PERMISSION,CLOSE,OLD_WI0004_CONTINUATION,AUTOMATIC_DAEMON_LIFECYCLE,AUTOMATIC_OPENCODE_LIFECYCLE,PHASE11_WI_LIFECYCLE_BEFORE_FRESH_PROJECT_AND_SESSION_READY
NEXT_STAGE=PHASE11_FRESH_PROJECT_CREATION_AND_OPENCODE_SESSION_BOOTSTRAP
NEXT_LEGAL_ACTION=CREATE_FRESH_PHASE11_VALIDATION_PROJECT_THEN_USER_START_NEW_OPENCODE_SESSION
STOP_CONDITION=FRESH_PHASE11_PROJECT_AND_NEW_OPENCODE_SESSION_MUST_BE_READY_BEFORE_FIRST_WI_LIFECYCLE
PERMANENT_INSUFFICIENT_EVIDENCE=FIRST_GATE_MACHINE_REPORT_RECOVERABLE=NO;INSUFFICIENT_EVIDENCE_FIRST_GATE_MACHINE_REPORT=YES;OLD_VALIDATION_PROJECT_LOCAL_EVIDENCE_LOST=YES;PHASE11_NOT_STARTED=YES;PHASE12_NOT_STARTED=YES;PRODUCT_COMPLETION_ALLOWED=NO
```
