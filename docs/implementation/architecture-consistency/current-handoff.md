...
CURRENT_STAGE=ERR417_SHARED_AUTHORITATIVE_STATE_READ_PRODUCT_FIX
CURRENT_STAGE_STATUS=COMMITTED_AND_PUSHED
LAST_COMPLETED_STAGE=ERR417_SHARED_AUTHORITATIVE_STATE_READ_PRODUCT_FIX
CURRENT_BLOCKER=MANUAL_DAEMON_RESTART_REQUIRED
...
LATEST_DEVELOPMENT_FAILURE=ERR-479_CLOSED_PRE_PRODUCT_BY_V259
FAILURE_LEDGER_BACKFILL=ERR-476,ERR-477,ERR-478,ERR-479
PRIOR_FAILURE_RECONCILIATION=PASS_ERR476_ERR479_BACKFILLED
UNRECORDED_FAILURES=0
EXPERIENCE_FILE_READ=YES_LATEST_WITH_ERR479
PRODUCT_VALIDATION_CONTRACT_ID=VC-V243-001
PRODUCT_VALIDATION_CONTRACT_HASH=4367F73B1F3AE5660E74020D72A87A3A79174BE4C7DC15B186434FB59D90D0AB
...
DAEMON_ACTION_REQUIRED=USER_MANUAL_RESTART
OPENCODE_STATUS=UNKNOWN
OPENCODE_ACTION_REQUIRED=NONE
OPENCODE_SESSION_MODE=CONTINUE_CURRENT_SESSION
OPERATION_BOUNDARY=STOP_AT_MANUAL_DAEMON_RESTART_AFTER_ERR417_PRODUCT_AND_HANDOFF_PUSH
FORBIDDEN_ACTIONS=SPECFORGE_WORK_ITEM,WORKFLOW,CANDIDATE,GATE,USER_DECISION,MERGE_RUNNER,CODE_PERMISSION,CLOSE,VALIDATION_REPOSITORY_WRITE,AUTOMATIC_DAEMON_LIFECYCLE,AUTOMATIC_OPENCODE_LIFECYCLE
NEXT_STAGE=POST_ERR417_MANUAL_DAEMON_RESTART_READ_ONLY_RUNTIME_ACCEPTANCE
NEXT_LEGAL_ACTION=USER_MANUAL_DAEMON_RESTART
STOP_CONDITION=ERR417_PRIMARY_AND_HANDOFF_PUSH_COMPLETE_WAITING_MANUAL_DAEMON_RESTART
PERMANENT_INSUFFICIENT_EVIDENCE=FIRST_GATE_MACHINE_REPORT_RECOVERABLE=NO;INSUFFICIENT_EVIDENCE_FIRST_GATE_MACHINE_REPORT=YES;P0_OVERALL_COMPLETION_ALLOWED=NO
```
