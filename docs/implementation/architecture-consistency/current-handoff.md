...
CURRENT_STAGE=WI0004_READ_ONLY_RECOVERY_RECONCILIATION_PENDING
CURRENT_STAGE_STATUS=CANONICAL_TEMPLATE_FILL_ONLY_GOVERNANCE_FIX_V158_COMPLETE
LAST_COMPLETED_STAGE=V158_CANONICAL_TEMPLATE_FILL_ONLY_GOVERNANCE_FIX_PASS
CURRENT_BLOCKER=WI0004_AUTHORITATIVE_LOCAL_STATE_RECONCILIATION_REQUIRED_BEFORE_ANY_LIFECYCLE_ACTION
REMOTE_HEAD_BASELINE=ae320cb79142292bb1c39fec41605cedc4ae4302
AUTHORITY_BASELINE_COMMIT=19289ed3d717216b98a63c7bcda45983185ef5b2
VALIDATION_PROJECT=D:\code\temp\SpecForge-P0-Validation
CURRENT_WI=WI-0004
AUTHORITATIVE_WI_STATE=approval_required
...
READ_ONLY_RECONCILIATION_RESULT=PASS_REPOSITORY_FACTS_RECEIPT_INTERNAL_REFERENCE_INVALID
...
OPERATION_BOUNDARY=WI0004_READ_ONLY_RECONCILIATION_ONLY_NO_LIFECYCLE_ACTION
FORBIDDEN_ACTIONS=CANDIDATE_GATE_RERUN,USER_DECISION,MERGE,CODE_PERMISSION,IMPLEMENTATION,VERIFICATION,CLOSE,DAEMON_LIFECYCLE,OPENCODE_LIFECYCLE
NEXT_STAGE=WI0004_READ_ONLY_RECOVERY_RECONCILIATION
NEXT_LEGAL_ACTION=READ_ONLY_RECONCILE_VALIDATION_REPO_WI0004_STATE_BRANCH_IMMUTABLE_EVIDENCE_AND_USER_AUTHORIZATION_BOUNDARY
STOP_CONDITION=WI0004_READ_ONLY_RECOVERY_RECONCILIATION_COMPLETE
...
LATEST_DEVELOPMENT_FAILURE=ERR-305_V158_MANIFEST_DIAGNOSTIC_KEY_MISMATCH_CLOSED_NO_PRODUCT_SIDE_EFFECT
FAILURE_LEDGER_BACKFILL=ERR-264,ERR-265,ERR-266,ERR-267,ERR-268,ERR-269,ERR-270,ERR-271,ERR-272,ERR-273,ERR-274,ERR-275,ERR-276,ERR-277,ERR-278,ERR-279,ERR-280,ERR-281,ERR-282,ERR-283,ERR-284,ERR-285,ERR-286,ERR-287,ERR-288,ERR-289,ERR-290,ERR-291,ERR-292,ERR-293,ERR-294,ERR-295,ERR-296,ERR-297,ERR-298,ERR-299,ERR-300,ERR-301,ERR-302,ERR-303,ERR-304,ERR-305
PRIOR_FAILURE_RECONCILIATION=PASS_ERR290_ERR305_BACKFILLED_AND_V158_CANONICAL_TEMPLATE_FILL_ONLY_GOVERNANCE_FIX_VALIDATED
UNRECORDED_FAILURES=0
EXPERIENCE_FILE_READ=YES_LATEST_WITH_ERR290_ERR305
EXPERIENCE_RE_READ_REQUIRED=NO_AFTER_V158_VALIDATION
```
...
- 下一阶段只允许对 `D:\code\temp\SpecForge-P0-Validation` 的 WI-0004 做只读恢复对账；不得执行 Gate、User Decision、Merge、Code Permission、Implementation、Verification、Close。
- WI-0004 的 handoff claim 仍为 `approval_required`，但在新的有副作用生命周期动作前必须重新读取本地持久化 Work Item 与 immutable evidence 证明。
- 本轮不启动、不停止、不重启 daemon 或 OpenCode。
- V158 已把固定机器模板收紧为 `FILL_ONLY` exact-schema，并修复 V157 generated TypeScript test 的 newline escape；同时统一 Artifact target hash 为 `NORMALIZED_UTF8_LF_SINGLE_TERMINAL_LF` producer/consumer 语义域；Bootstrap 工具访问保持 `SERIAL_ONE_PHASE_PER_TOOL_CALL`，该修复不改变 WI-0004 的只读恢复边界。
