...
CURRENT_STAGE=POST_REINSTALL_DAEMON_PROCESS_AND_HANDSHAKE_READ_ONLY_PREFLIGHT
CURRENT_STAGE_STATUS=IDENTIFIED
LAST_COMPLETED_STAGE=POST_REINSTALL_USERLEVEL_INSTALL_RESTORE
LAST_COMPLETED_STAGE_STATUS=USERLEVEL_DEPLOYED
CURRENT_BLOCKER=DAEMON_PROCESS_AND_HANDSHAKE_STATUS_NOT_YET_AUDITED
REMOTE_HEAD_BASELINE=e5283f468a0aba77c8349be9b0e8f640cc6a8e12
...
APPLICABLE_EXPERIENCE_RULES=EXP-001,EXP-002,EXP-007,EXP-008,EXP-013,EXP-015,EXP-019,EXP-020,EXP-025,EXP-033,EXP-035,EXP-037,EXP-038,EXP-044,EXP-045,EXP-058,EXP-060,EXP-092,EXP-093,EXP-094
REPEATED_ERROR_CHECK=PASS_ERR490_LINKED_TO_ERR480_CLASS;ERR491_CLASSIFIED_AS_COLLECTION_ORDER_VALIDATOR_DEFECT;ERR492_CLASSIFIED_AS_INLINE_CMD_CONTROL_FLOW_DEFECT
...
DAEMON_RECOVERY_SESSION_ACTION=NOT_STARTED_BY_RECOVERY_SESSION
DAEMON_ACTION_REQUIRED=READ_ONLY_PROCESS_AND_HANDSHAKE_PREFLIGHT_THEN_USER_MANUAL_START_IF_CONFIRMED_STOPPED
OPENCODE_STATUS=UNKNOWN
OPENCODE_RECOVERY_SESSION_ACTION=NOT_STARTED_BY_RECOVERY_SESSION
OPENCODE_ACTION_REQUIRED=NONE_UNTIL_DAEMON_HEALTH_ACCEPTED
OPENCODE_SESSION_MODE=START_NEW_SESSION_AFTER_DAEMON_HEALTH_ACCEPTED
OPERATION_BOUNDARY=STOP_AT_READ_ONLY_DAEMON_PREFLIGHT;NO_SPECFORGE_LIFECYCLE;NO_OLD_WI0004_CONTINUATION
FORBIDDEN_ACTIONS=SPECFORGE_WORK_ITEM,WORKFLOW,CANDIDATE,GATE,USER_DECISION,MERGE_RUNNER,CODE_PERMISSION,CLOSE,OLD_VALIDATION_PROJECT_RECOVERY,AUTOMATIC_DAEMON_LIFECYCLE,AUTOMATIC_OPENCODE_LIFECYCLE
NEXT_STAGE=POST_REINSTALL_DAEMON_PROCESS_AND_HANDSHAKE_READ_ONLY_PREFLIGHT
NEXT_LEGAL_ACTION=USER_GIT_SYNC_THEN_READ_ONLY_DAEMON_PROCESS_AND_HANDSHAKE_AUDIT
STOP_CONDITION=READ_ONLY_DAEMON_PREFLIGHT_MUST_COMPLETE_BEFORE_ANY_MANUAL_DAEMON_START
