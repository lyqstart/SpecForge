...
CURRENT_STAGE=PHASE11_STAGE_A_PRODUCT_FIX_VALIDATED_PENDING_GIT_SYNC
CURRENT_STAGE_STATUS=REAL_APPLIED
LAST_COMPLETED_STAGE=PHASE11_STAGE_A_INDEPENDENT_AUDIT
LAST_COMPLETED_STAGE_STATUS=BLOCKED_APPROVAL_UNSAFE
CURRENT_BLOCKER=ERR496_ERR498_PRODUCT_FIX_PENDING_COMMIT_DEPLOY_AND_REAL_WI_RECOVERY
REMOTE_HEAD_BASELINE=729130bdb978b7f3c4fe82a1d495e918da3407ca
...
VALIDATION_PROJECT_WORKTREE=CLEAN
VALIDATION_PROJECT_SPEC_DIR_EXISTS=NO
VALIDATION_PROJECT_INITIAL_BUSINESS_REQUEST=BUSINESS_REQUEST.md
CURRENT_WI=WI-0001
AUTHORITATIVE_WI_STATE=approval_required
LATEST_IMMUTABLE_EVIDENCE=attempt-0006:source=gate_run:10_OF_10_PASSED:APPROVAL_UNSAFE_BY_INDEPENDENT_AUDIT
...
LATEST_PRODUCT_FIX=917ca12aa4a2b1eceb89f30504a97e7c35bce1d4:ERR417_SHARED_AUTHORITATIVE_STATE_READ_SIDE_EFFECT_FREE
LATEST_DEVELOPMENT_FAILURE=ERR-500
HISTORICAL_PENDING_HARNESS_ERROR=ERR-480:FIX_IMPLEMENTED_PENDING_LIVE_RUNTIME_ACCEPTANCE
FAILURE_LEDGER_BACKFILL=ERR-481,ERR-482,ERR-483,ERR-484,ERR-485,ERR-486,ERR-487,ERR-488,ERR-489,ERR-490,ERR-491,ERR-492,ERR-493,ERR-494,ERR-495
PRIOR_FAILURE_RECONCILIATION=PASS
UNRECORDED_FAILURES=0
EXPERIENCE_FILE_READ=YES_LATEST_WITH_ERR500
...
DAEMON_ACTION_REQUIRED=NONE_KEEP_CURRENT_PROCESS_RUNNING_UNTIL_DEPLOYMENT_BOUNDARY
DAEMON_PID=3012
DAEMON_PORT=7040
DAEMON_HANDSHAKE_VALID=YES
DAEMON_HEALTH_STATUS=PASS
OPENCODE_STATUS=RUNNING_INVENTORYFLOW_SESSION
OPENCODE_RECOVERY_SESSION_ACTION=NOT_STARTED_BY_RECOVERY_SESSION
OPENCODE_ACTION_REQUIRED=KEEP_CURRENT_SESSION_FROZEN_AT_APPROVAL_REQUIRED
OPENCODE_SESSION_MODE=CONTINUE_CURRENT_INVENTORYFLOW_SESSION_AFTER_DEPLOYMENT
OPERATION_BOUNDARY=PRODUCT_FIX_ONLY;KEEP_WI0001_FROZEN;NO_USER_DECISION;NO_INVENTORYFLOW_WRITE;NO_DAEMON_OR_OPENCODE_LIFECYCLE
...
NEXT_STAGE=USER_GIT_SYNC_AND_USERLEVEL_DEPLOYMENT
NEXT_LEGAL_ACTION=USER_COMMIT_PUSH_EXACT_PRODUCT_FIX_THEN_UPGRADE_USERLEVEL_AND_MANUALLY_RESTART_DAEMON_OPENCODE
STOP_CONDITION=PRODUCT_FIX_MUST_BE_COMMITTED_DEPLOYED_AND_RUNTIME_RESTARTED_BEFORE_WI0001_RECOVERY
PERMANENT_INSUFFICIENT_EVIDENCE=FIRST_GATE_MACHINE_REPORT_RECOVERABLE=NO;INSUFFICIENT_EVIDENCE_FIRST_GATE_MACHINE_REPORT=YES;OLD_VALIDATION_PROJECT_LOCAL_EVIDENCE_LOST=YES;OPENCODE_NEW_SESSION_NOT_STARTED=YES;PHASE11_FIRST_WI_NOT_STARTED=YES;PHASE12_NOT_STARTED=YES;PRODUCT_COMPLETION_ALLOWED=NO
```
