...
CURRENT_STAGE=PHASE11_TASK_SCOPE_CANDIDATE_GATE_PRODUCT_FIX_VALIDATED_PENDING_GIT_SYNC
CURRENT_STAGE_STATUS=PRODUCT_FIX_APPLIED_VALIDATED_PENDING_COMMIT
LAST_COMPLETED_STAGE=PHASE11_INVENTORYFLOW_POST_SPEC_MERGE_GATE
LAST_COMPLETED_STAGE_STATUS=ATTEMPT0017_POST_MERGE_GATE_PASS_THEN_IMPLEMENTATION_PREFLIGHT_BLOCKED_BY_TASK_SCOPE_GAP
CURRENT_BLOCKER=ERR516_TASK_ALLOWED_WRITE_FILES_OUTSIDE_APPROVED_IMPACT_SCOPE_AND_MODULE_CODE_PATHS
REMOTE_HEAD_BASELINE=464395bd2856aebec354c64dae1f0c8a465c0c18
AUTHORITY_BASELINE_COMMIT=464395bd2856aebec354c64dae1f0c8a465c0c18
VALIDATION_PROJECT=D:\code\InventoryFlow
VALIDATION_PROJECT_BRANCH=main
VALIDATION_PROJECT_HEAD=87e33a3c89c21a271ff60f8984acb8fdd94f4020
VALIDATION_PROJECT_WORKTREE=RUNTIME_GOVERNANCE_WRITES_ONLY_NO_IMPLEMENTATION_CODE_WRITES
...
LATEST_IMMUTABLE_EVIDENCE=attempt-0017:post_merge_gate:PASS;attempt-0016:candidate_gates:10_OF_10_PASS
HISTORICAL_VALIDATION_PROJECT=D:\code\temp\SpecForge-P0-Validation
HISTORICAL_WI=WI-0004
HISTORICAL_WI_STATE=closed
HISTORICAL_WI_EVIDENCE=attempt-0006:source=gate_run:summary_status=passed:verification_gate=passed:formal_version_gate=passed:LOCAL_ARTIFACTS_LOST_BY_OS_REINSTALL
LATEST_PRODUCT_FIX=464395bd2856aebec354c64dae1f0c8a465c0c18:PHASE11_AGENT_GUIDANCE_DEPLOYED
LATEST_DEVELOPMENT_FAILURE=ERR-525
HISTORICAL_PENDING_HARNESS_ERROR=ERR-480:FIX_IMPLEMENTED_PENDING_LIVE_RUNTIME_ACCEPTANCE
FAILURE_LEDGER_BACKFILL=ERR-481,ERR-482,ERR-483,ERR-484,ERR-485,ERR-486,ERR-487,ERR-488,ERR-489,ERR-490,ERR-491,ERR-492,ERR-493,ERR-494,ERR-495,ERR-496,ERR-497,ERR-498,ERR-499,ERR-500,ERR-501,ERR-502,ERR-503,ERR-504,ERR-505,ERR-506,ERR-507,ERR-508,ERR-509,ERR-510,ERR-511,ERR-512,ERR-513,ERR-514,ERR-515,ERR-516,ERR-517,ERR-518,ERR-519,ERR-520,ERR-521,ERR-522,ERR-523,ERR-524,ERR-525
PRIOR_FAILURE_RECONCILIATION=PASS
UNRECORDED_FAILURES=0
EXPERIENCE_FILE_READ=YES_LATEST_WITH_ERR525
APPLICABLE_EXPERIENCE_RULES=EXP-001,EXP-002,EXP-004,EXP-006,EXP-007,EXP-010,EXP-011,EXP-015,EXP-017,EXP-036,EXP-072,EXP-082,EXP-087,EXP-093,EXP-094
REPEATED_ERROR_CHECK=PASS_ERR523_AST_TRAVERSAL_SHORT_CIRCUIT_FIXED_WITH_VOID_CALLBACK_AND_SYNTHETIC_FIXTURE
...
USERLEVEL_INSTALL_STATUS=INSTALLED_AND_VERIFIED
...
DAEMON_RECOVERY_SESSION_ACTION=USER_MANUAL_START_COMPLETED
DAEMON_ACTION_REQUIRED=USER_MANUAL_RESTART_AFTER_GIT_SYNC_AND_USERLEVEL_UPGRADE_RUNTIME_CODE_CHANGED
DAEMON_PID=UNKNOWN_CURRENT_RESTART_PID_NOT_AUDITED
DAEMON_PORT=44888
DAEMON_HANDSHAKE_VALID=YES_FROM_CURRENT_RESTART_OUTPUT
DAEMON_HEALTH_STATUS=STARTED_SUCCESSFULLY_HEALTH_ENDPOINT_NOT_REAUDITED_THIS_STAGE
OPENCODE_STATUS=RUNNING_INVENTORYFLOW_SESSION_FROZEN_AT_POST_MERGE_VERIFIED
OPENCODE_RECOVERY_SESSION_ACTION=NOT_STARTED_BY_RECOVERY_SESSION
OPENCODE_ACTION_REQUIRED=KEEP_CURRENT_SESSION_FROZEN_UNTIL_PRODUCT_FIX_DEPLOYED;THEN_START_NEW_FRESH_VALIDATION_SESSION
OPENCODE_SESSION_MODE=CONTINUE_CURRENT_SESSION_FROZEN_NOW;START_NEW_SESSION_AFTER_PRODUCT_FIX_DEPLOYMENT
WORKBUDDY_STATUS=CURRENT_WI0001_AUDIT_FROZEN_AFTER_IMPLEMENTATION_PREFLIGHT_SCOPE_BLOCK
WORKBUDDY_SESSION_MODE=CONTINUE_CURRENT_SESSION_FROZEN_NOW;START_NEW_SESSION_FOR_FRESH_PHASE11_RERUN
OPERATION_BOUNDARY=SPECFORGE_TASK_SCOPE_GATE_FIX_ONLY;NO_INVENTORYFLOW_WRITES;NO_SPECFORGE_LIFECYCLE;NO_CODE_PERMISSION_BYPASS
FORBIDDEN_ACTIONS=SPECFORGE_SELF_DEVELOPMENT_WORK_ITEM,WORKFLOW,CANDIDATE,GATE,USER_DECISION,MERGE_RUNNER,CODE_PERMISSION,CLOSE,OLD_WI0004_CONTINUATION,AUTOMATIC_DAEMON_LIFECYCLE,AUTOMATIC_OPENCODE_LIFECYCLE,PHASE11_WI_LIFECYCLE_BEFORE_PLUGIN_PROJECT_INITIALIZATION_CONFIRMED
NEXT_STAGE=USER_GIT_SYNC_USERLEVEL_UPGRADE_DAEMON_RESTART_THEN_FRESH_PHASE11_VALIDATION_PROJECT
NEXT_LEGAL_ACTION=USER_COMMIT_PUSH_EXACT_6_FILES_THEN_UPGRADE_USERLEVEL_RESTART_DAEMON_AND_START_FRESH_PHASE11_VALIDATION
STOP_CONDITION=PRODUCT_FIX_MUST_BE_GIT_SYNCED_DEPLOYED_AND_DAEMON_RESTARTED_BEFORE_ANY_NEW_PHASE11_VALIDATION_LIFECYCLE
PERMANENT_INSUFFICIENT_EVIDENCE=FIRST_GATE_MACHINE_REPORT_RECOVERABLE=NO;INSUFFICIENT_EVIDENCE_FIRST_GATE_MACHINE_REPORT=YES;OLD_VALIDATION_PROJECT_LOCAL_EVIDENCE_LOST=YES;PHASE11_FIRST_WI_FULL_E2E=NOT_COMPLETE;PHASE12_NOT_STARTED=YES;PRODUCT_COMPLETION_ALLOWED=NO
```
